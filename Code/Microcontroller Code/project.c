/********************************************************************************
 File Name : project.c 
 Written by: Manjunath.K,Amit, Gowtham
 Date      : 23-10-2016
 Purpose/ Description : Autonomous serving bot (Firebird bot code)
						...
						successfully created an android application from which order can be placed by a customer and the order is served to his 
						table by a firebird V robot.The task was made more challenging by adding two more bots for serving and hence there was 
						requirement of coordination among three bots to ensure proper delivery of orders and avoiding collisions and deadlocks. The 
						same was achieved by using round robin scheduling algorithm for tasking bots and carefully designing onward and backward 
						path from start point to destination and planning re-routing algorithms in real time to avoid collisions and deadlocks by using 
						techniques similar to exponential backoff algorithm used for collision avoidance in computer networks using variable delays.
...
/**********************************************************************************/
// Following are the function prototype declaration
// Prototype comments the overview of the function
// For complete details please check the comment section of the particular function implementation part
/**********************************************************************************/
...
//			   more details in the function implementation (below)
/**********************************************************************************/
void port_init();
...
//Output: void
//		  velocity of the motor can be controlled with this funtion.
//		  check the implementation part for the complete details
...
//Input : void
//Output: void
//		  Function used to take the robot from the finish line to the starting point
//		  of the arena. So that robot is ready to deliver the next order in the queue
//		  More details in the implementation part of the function
/**********************************************************************************/
void reposition();
...
//				It is responsible in the backward path to the counter
/**********************************************************************************/
...
//				Samples IR and Sharp sensor and dumps the value into the specified variables
//				
/**********************************************************************************/
void sample_sensor();
...
/**********************************************************************************/
// Function to adjust robot path when robot goes out of black line
//Input : void
//Output: void
//		  When the robot goes out of the path, this function is responsible for
//		  searching for that line in the area and adjusts the robot path back.
/**********************************************************************************/
void adjust_path();
...
/**********************************************************************************/
//Zigbee data, received through UART
//saved into data
//datac is the copy of the data (for processing)
/**********************************************************************************/
...
/**********************************************************************************/
//Indicates the Zigbee received values
//Initial coordinates
//Destination coordinates
//Start of the Zigbee message 
/**********************************************************************************/
